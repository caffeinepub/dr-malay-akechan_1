...
export class Backend implements backendInterface {
    ...
    async getClinics(): Promise<Array<Clinic>> {
        if (this.processError) {
            try {
                const result = await this.actor.getClinics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFooter(): Promise<FooterContent | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFooter();
    ...
    async getHeader(): Promise<HeaderContent | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getHeader();
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AboutContent]): AboutContent | null {
...
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FooterContent]): FooterContent | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_HeaderContent]): HeaderContent | null {
    return value.length === 0 ? null : value[0];
}
